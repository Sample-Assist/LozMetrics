    ...
    useEffect(() => {
        const fetchBlendedCostData = async () => {
            ...
            try {
                ...
                // Prepare the cost data for the pie chart
                const serviceCostMap = {};
    
                // Iterate over the results to accumulate service costs
                data.ResultsByTime.forEach(monthData => {
                    monthData.Groups.forEach(group => {
                        ...
                        // Accumulate costs for each service
                ...
                // Convert the service cost map to arrays for labels and values
